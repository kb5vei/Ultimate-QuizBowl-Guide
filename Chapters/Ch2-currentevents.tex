\chapter{Current Events}
	...
	\section{Business and Economics}
		...
		Fears of Coronavirus (see Coronavirus, \ref{Coronavirus} on \cpageref{Coronavirus}), along with a fed decision to not issue a rate cut caused a late-January 2020 slump in the Stock Market.  
	...
	\section{Science}
		...
		\subsection{Geology}
			...
			On December 20, 2020, the K\={\i}lauea volcano on the big island of Hawaii erupted for the first time since 2018.  The eruption has been contained entirely in the summit crater.  The lake that had formed at the bottom of the crater was quickly boiled off, and a lava lake has taken its place.  (See Kilauea - \ref{Kilauea} on \cpageref{Kilauea})
